...
```json
{
  ...
  "data": {
    ...
    "userId": 1,
    "rating": 9,
    "comment": "Absolutely brilliant film!"
  }
}
```
    ...
    "tickets": [
      {
        ...
        "bookingId": 1,
        "seatId": 1,
        "ticketNumber": "TK-1709251200000-EF012345",
        "price": "500.00",
        "isCheckedIn": false
      },
      {
        ...
        "bookingId": 1,
        "seatId": 2,
        "ticketNumber": "TK-1709251200001-GH678910",
        "price": "300.00",
        "isCheckedIn": false
      }
    ]
...
```json
{
  ...
  "data": {
    ...
    "showtime": {
      "id": 1,
      "startTime": "2026-03-10T14:00:00.000Z",
      "endTime": "2026-03-10T16:28:00.000Z",
      "basePrice": "500.00"
    },
    "theater": {
      "id": 1,
...
```json
{
  ...
  "data": {
    ...
    "totalUsers": "210",
    "topMovies": [{ "id": 1, "title": "Inception", "ticketsSold": "120" }]
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "summary": {
      ...
      "totalBookings": "95",
      "avgOrderValue": "442.10",
      "minOrderValue": "200.00",
      "maxOrderValue": "1500.00"
    },
    "trend": [
      {
